...
import NotesViewCard from '../library/NotesViewCard'
import AddNoteButton from '../library/AddNoteButton'
import { deleteNote } from '../actions'
import { styles } from './styles'
import { getColor } from '../library/helpers'
import { Typo } from '../library/Typography'
    ...
    return (
      <View style={ styles.allNotesContainer }>
        <StatusBar
          ...
          animated={true}
        />
        <Toolbar title="ADD TASK" color={getColor('paperBlue')}/>
        { this.renderList() }
